<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="课程名称" prop="kechengmingcheng">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.kechengmingcheng" label="课程名称" prop="kechengmingcheng">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="成绩" prop="chengji">
					<el-input v-model="ruleForm.chengji" placeholder="成绩" clearable  :readonly="ro.chengji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="成绩" prop="chengji">
					<el-input v-model="ruleForm.chengji" placeholder="成绩" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="学号" prop="xuehao">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xuehao" label="学号" prop="xuehao">
		...
		init(id,type) {
			...
			kechengmingchengChange () {
				this.$http({
					...
					if (data && data.code === 0) {
						if(data.data.xueqi){
							this.ruleForm.xueqi = data.data.xueqi
						}
						if(data.data.nianxian){
							this.ruleForm.nianxian = data.data.nianxian
						}
						if(data.data.chengji){
							this.ruleForm.chengji = data.data.chengji
						}
