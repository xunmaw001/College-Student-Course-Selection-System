	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="课程类型" prop="kechengleixing">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="上课地点" prop="shangkedidian">
					<el-input v-model="ruleForm.shangkedidian" placeholder="上课地点" clearable  :readonly="ro.shangkedidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="上课地点" prop="shangkedidian">
					<el-input v-model="ruleForm.shangkedidian" placeholder="上课地点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="学期" prop="xueqi">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="教师工号" prop="jiaoshigonghao">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jiaoshigonghao" label="教师工号" prop="jiaoshigonghao">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="上课时间" prop="shangkeshijian">
					<el-input
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shangkeshijian" label="上课时间" prop="shangkeshijian">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shangkeshijian}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="课程详情" prop="kechengxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengxiangqing" label="课程详情" prop="kechengxiangqing">
...
export default {
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../springboot43ra2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
